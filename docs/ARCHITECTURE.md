...
| `LYNCEUS_LLM_RAISONNEMENT` | *(défaut du fournisseur)* | `non`, `faible`, `moyen`, `eleve`. Le raisonnement est facturé en sortie puis jeté : c'est le premier poste de dépense |
